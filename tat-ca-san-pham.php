						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-card">
								<div class="product-grid-content">
									...
									<div class="product-card--body">
										<div class="card-image">
											<img src="http://localhost:81/webbansach/<?php echo $row['anhchinh']; ?>" alt="" style="height: 350px; width: 350px;">
											<div class="hover-contents">
												<a href="san-pham.php?id=<?php echo $row['masanpham']; ?>" class="hover-image">
													<img src="http://localhost:81/webbansach/<?php echo $row['anhphu1']; ?>" alt="" style="height: 350px;     width: 350px;">
												</a>
											</div>
										</div>
								...
								<div class="product-list-content">
									<div class="card-image">
										<img src="http://localhost:81/webbansach/<?php echo $row['anhchinh']; ?>" alt="">
									</div>
									<div class="product-card--body">
										<div class="product-header">
											<a href="" class="author">
