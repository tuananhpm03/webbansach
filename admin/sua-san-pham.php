...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    echo '<script type="text/JavaScript"> window.location.href = "http://localhost:81/webbansach/admin/san-pham.php"; </script>';
}
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="<?php echo 'http://localhost:81/webbansach/'.$sanpham['anhchinh']; ?>" alt="" style="width: 200px; height: 200px;">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="<?php echo 'http://localhost:81/webbansach/'.$sanpham['anhphu1']; ?>" alt="" style="width: 200px; height: 200px;">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="<?php echo 'http://localhost:81/webbansach/'.$sanpham['anhphu2']; ?>" alt="" style="width: 200px; height: 200px;">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="<?php echo 'http://localhost:81/webbansach/'.$sanpham['anhphu3']; ?>" alt="" style="width: 200px; height: 200px;">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="<?php echo 'http://localhost:81/webbansach/'.$sanpham['anhphu4']; ?>" alt="" style="width: 200px; height: 200px;">
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
