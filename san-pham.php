            ...
            <div class="container">
              ...
              "asNavFor": ".product-slider-nav"
                            ...
                            <div class="single-slide">
                                <img src="http://localhost:81/webbansach/<?php echo $sanpham['anhchinh']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost:81/webbansach/<?php echo $sanpham['anhphu1']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost:81/webbansach/<?php echo $sanpham['anhphu2']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost:81/webbansach/<?php echo $sanpham['anhphu3']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost:81/webbansach/<?php echo $sanpham['anhphu4']; ?>" alt="">
                            </div>
                        </div>
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-card--body">
                                    <div class="card-image">
                                        <img src="http://localhost:81/webbansach/<?php echo $row['anhchinh']; ?>" alt="" style="height: 350px;">
                                    </div>
                                    <div class="price-block">
