                ...
                <div class=" col-xl-3 col-lg-4 col-sm-6">
                    <div class="single-footer pb--40">
                        ...
                        <div class="footer-contact">
                            <p><span class="label">Địa Chỉ:</span><span class="text">Phú Lợi, Thành Phố Thủ Dầu Một, Bình Dương</span></p>
        ...
        $(document).ready(function() {
            ...
            if(giohang == null){
                ...
                for (var i = 0; i < giohang.length; i++) {
                    ...
                    $('.sanpham_giohang').append('<div class=" single-cart-block "> <div class="cart-product"> <a href="san-pham.php?id='+giohang[i].masanpham+'" class="image"> <img style="width: 100px; height: 100px;" src="http://localhost:81/webbansach/'+giohang[i].anhchinh+'" alt=""> </a> <div class="content"> <h3 class="title"><a href="san-pham.php?id='+giohang[i].masanpham+'">'+giohang[i].tensanpham+'</a> </h3> <p class="price"><span class="qty">'+giohang[i].soluong+' ×</span> '+giohang[i].giaban+'đ</p> </div> </div> </div>')
                    tien += gia
                }
