                        ...
                        <div class="container">
                            <div class="home-content text-center text-sm-left position-relative">
                                <div class="hero-partial-image image-right">
                                    <img src="http://localhost:81/webbansach/<?php echo $row['anhchinh'] ?>" alt="" style="width: 720px; height: 509px;">
                                </div>
                ...
                <div class="row space-db--30">
                    <div class="col-lg-6 col-md-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img src="http://localhost:81/webbansach/admin/upload/ms_banner_img2.png" alt="">
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img src="http://localhost:81/webbansach/admin/upload/ms_banner_img3.png" alt="">
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="http://localhost:81/webbansach/<?php echo $row['anhchinh']; ?>" alt="" style="width: 220px; height:220px; ">
                                                <div class="hover-contents">
                                                    <a href="san-pham.php?id=<?php echo $row['masanpham']; ?>" class="hover-image">
                                                        <img src="http://localhost:81/webbansach/<?php echo $row['anhphu1']; ?>" alt="" style="width: 220px; height:220px; ">
                                                    </a>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-8 mb--30">
                        <div class="promo-wrapper promo-type-one">
                            <a href="#" class="promo-image  promo-overlay bg-image"
                                data-bg="">
                                <img src="http://localhost:81/webbansach/admin/upload/breadcrumb_bg2.png" alt="">
                            </a>
                    ...
                    <div class="col-lg-4 mb--30">
                        <div class="promo-wrapper promo-type-two ">
                            <a href="tat-ca-san-pham.php" class="promo-image promo-overlay bg-image"
                                data-bg="">
                                <img src="http://localhost:81/webbansach/admin/upload/hbanner_img3.png" alt="" style="height: 245px;">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <section class="section-margin">
        ...
        <div class="container">
            <div class="brand-slider sb-slick-slider border-top border-bottom" data-slick-setting='{
                ...
                <div class="single-slide">
                    <img src="image/others/brand-1.png" alt="">
                </div>
                <div class="single-slide">
                    <img src="image/others/brand-2.png" alt="">
                </div>
                <div class="single-slide">
                    <img src="image/others/brand-3.png" alt="">
                </div>
                <div class="single-slide">
                    <img src="image/others/brand-4.png" alt="">
                </div>
                <div class="single-slide">
                    <img src="image/others/brand-5.png" alt="">
                </div>
                <div class="single-slide">
                    <img src="image/others/brand-6.png" alt="">
                </div>
                <div class="single-slide">
                    <img src="image/others/brand-1.png" alt="">
                </div>
